...
```javascript
isRowMajor = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert-is-row-major@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert-is-row-major@umd/bundle.js"></script>
```
